...
if ($object->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('tagelementplugin_core_path', null, $modx->getOption('core_path') . 'components/tagelementplugin/') . 'model/';
            $modx->addPackage('tagelementplugin', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/tagelementplugin/model/schema/tagelementplugin.mysql.schema.xml';
